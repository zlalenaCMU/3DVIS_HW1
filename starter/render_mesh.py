...
def render_cow(
    ...
    print(vertices)
    return rend
def render_tetrahedron(cow_path, image_size=256, color=[0.7, 0.7, 1], device=None,
):
    # The device tells us whether we are rendering with GPU or CPU. The rendering will
    # be *much* faster if you have a CUDA-enabled NVIDIA GPU. However, your code will
    # still run fine on a CPU.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cow_path", type=str, default="../data/tetra.obj")
    #parser.add_argument("--output_path", type=str, default="../images/cow_render.jpg")
    parser.add_argument("--output_path", type=str, default="../images/tet_render.jpg")
    parser.add_argument("--image_size", type=int, default=256)
    args = parser.parse_args()
    #image = render_cow(cow_path=args.cow_path, image_size=args.image_size)
    image = render_tetrahedron( cow_path=args.cow_path,image_size=args.image_size)
